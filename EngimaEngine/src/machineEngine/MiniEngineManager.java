...
public class MiniEngineManager implements Serializable {
   ...
   // private InputStream inputStream;
    ...
    public void writeToFile(String FileName) throws IOException {
        ArrayList<MiniEngineManager> meds = new ArrayList();
        meds.add(this);
    ...
    public void readFromFile(String FileName) throws IOException, ClassNotFoundException {
        ...
        Throwable var = null;
        try {
            ArrayList<MiniEngineManager> meds = (ArrayList) in.readObject();
            this.listOfExceptionsDTO = ((MiniEngineManager) meds.get(0)).listOfExceptionsDTO;
            this.fullCodeDescriptionDTO = ((MiniEngineManager) meds.get(0)).fullCodeDescriptionDTO;
            this.theMachineEngine = ((MiniEngineManager) meds.get(0)).theMachineEngine;
            this.machineHistoryAndStatistics = ((MiniEngineManager) meds.get(0)).machineHistoryAndStatistics;
            // this.cteEnigma = ((EngineManager)meds.get(0)).cteEnigma;
            // this.schemaGenerated = ((EngineManager)meds.get(0)).schemaGenerated;
            this.isCodeConfigurationSet = ((MiniEngineManager) meds.get(0)).isCodeConfigurationSet;
            this.amountOfProcessedMessages = ((MiniEngineManager) meds.get(0)).amountOfProcessedMessages;
            this.menuValidator = ((MiniEngineManager) meds.get(0)).menuValidator;
            this.listOfRotors = ((MiniEngineManager) meds.get(0)).listOfRotors;
            this.reflectorId = ((MiniEngineManager) meds.get(0)).reflectorId;
    ...
    public MiniEngineManager cloneEngineManager() {
        try {
            ...
            return (MiniEngineManager) ois.readObject();
        } catch (IOException e) {
            return null;
    ...
    public String getNextStartingPositionByString(int missionSize){
        int[] nextStartingPositionByIndexes=getNextStartingPositionByIndexes(missionSize);
        return getStartingPositionStringFromIndexes(nextStartingPositionByIndexes);
    }
    ...
    public String getInitialStartingPosition(){
        ...
        keyboard=theMachineEngine.getKeyboardAsArray();
        currentPosition=getIndexArrayFromString(theLastStartingPos);
        lastIndex=0;
       // firstList=true;
...
/*    public void setUploadedBy(String uploadedBy) {
   ...
   /* public InputStream getInputStream(){
    ...
    public String getMachineReflectorId(){
        return this.theMachineEngine.getSelectedRelflectorId();
    }
