...
import bonus.ChatAreaRefresher;
import bonus.ChatLinesWithVersion;
...
public class ChatAreaController implements Closeable {
    ...
    public void initialize() {
      ...
      /*  mainChatLinesTextArea.setStyle("-fx-background-image: url('/Resources/power.jpg'); -fx-background-repeat: no-repeat; -fx-background-size: 500 500; -fx-background-position: center center;");
        mainChatLinesTextArea.setBackground(url("/Resources/power.jpg");*/
    }
