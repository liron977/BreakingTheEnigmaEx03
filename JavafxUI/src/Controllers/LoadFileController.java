...
public class LoadFileController {
    ...
    private void setStyle(ActionEvent event) {
        Scene scene=mainController.mainBorder.getScene();;
    ...
    public void setAnimationsBinding(){
        ...
        SimpleBooleanProperty isEnableAnimationsPropertyFromBruteForce=mainController.getBruteForceResultsTabController().getIsEnableAnimationsProperty();
